...
CREATE TABLE IF NOT EXISTS `ai_memory` (
    ...
    `memory_type` VARCHAR(50) NOT NULL COMMENT 'knowledge/weakness/preference/mistake/progress/note',
    `content` TEXT NOT NULL,
    `importance` INT DEFAULT 5 COMMENT '1-10, 10为最重要',
