...
from app.utils import get_greeting, get_week_day_chinese, get_consecutive_learning_days
...
def preview_as_student(course_id):
    ...
    for chapter in chapters:
        ...
        for lesson in chapter['lessons']:
            ...
            lesson['completed'] = len(progress) > 0 and bool(progress[0].get('completed'))
...
def preview_lesson_as_student(lesson_id):
    ...
    for c in chapters:
        ...
        for l in c['lessons']:
            ...
            l['completed'] = len(progress) > 0 and bool(progress[0].get('completed'))
